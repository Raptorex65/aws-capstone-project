...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-caps-rds-db.cbytovvpw3i8.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'aws-caps-s3-bucket' # please enter your s3 bucket name
